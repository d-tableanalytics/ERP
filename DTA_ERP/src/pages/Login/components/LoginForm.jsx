    ...
    <div className="w-full max-w-[480px] flex flex-col gap-8">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <label className="flex flex-col gap-1.5">
          <span className="text-slate-700 dark:text-slate-300 text-sm font-semibold leading-normal">
            Email
          </span>
        ...
        <div className="flex items-center justify-between mt-1">
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              className="form-checkbox w-4 h-4 rounded text-primary border-slate-300 focus:ring-primary/50 focus:ring-offset-0 cursor-pointer"
              type="checkbox"
            />
