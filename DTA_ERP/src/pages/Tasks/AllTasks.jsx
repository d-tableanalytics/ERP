...
const AllTasks = () => {
    ...
    const quickStats = [
        ...
        { label: 'Completed', value: getStatusCount('Completed'), dot: 'bg-[#137fec]', bg: 'bg-blue-50', color: 'text-[#137fec]' },
    ];
        ...
        <MainLayout title="All Tasks">
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-5 h-10 bg-[#137fec] hover:bg-[#106bc7] text-white rounded-lg font-bold text-sm transition-all active:scale-95 shadow-sm"
                >
            ...
            <div className="flex flex-wrap items-end gap-3 mb-8">
                ...
                {dateRange === 'Custom' && (
                    <>
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="border border-[#137fec] rounded-lg h-11 flex items-center px-2.5 gap-1.5 bg-white min-w-[130px]">
                ...
                <button
                    ...
                    className={`flex items-center gap-2 px-4 h-11 rounded-lg font-bold text-sm transition-all shadow-sm self-end
                        bg-[#137fec] hover:bg-[#106bc7] text-white active:scale-95`}
                >
                    <FileUp size={18} />
                    Export
                </button>
                    ...
                    <div onClick={e => e.stopPropagation()} className="bg-white rounded-lg w-full max-w-md p-6 relative max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="flex justify-end mt-6 gap-2">
                            <button
                                ...
                                className="px-5 py-2 bg-[#137fec] text-white rounded-lg font-bold hover:bg-[#106bc7] transition-all"
                            >
                ...
                <div className="flex gap-6 overflow-x-auto">
                    {[
                        ...
                        <button key={tab.key} onClick={() => setStatusFilter(tab.key)}
                            ...
                            {statusFilter === tab.key && <div className="absolute bottom-0 left-0 right-0 h-1 bg-[#137fec] rounded-t-full" />}
                        </button>
                    ))}
                </div>
            </div>
                    ...
                    filteredTasks.map((task) => (
                        <div key={task.id}
                            className={`bg-white rounded-xl border border-white shadow-sm transition-all duration-300 
                                ${expandedTasks.has(task.id) ? 'ring-2 ring-[#137fec]/30' : 'hover:shadow-md'}
                                ${isHighlighted ? 'ring-2 ring-[#137fec] shadow-[0_0_20px_rgba(0,208,148,0.3)]' : ''}
                            `}>
                            ...
                            {expandedTasks.has(task.id) && (
                                <div className="px-6 pb-5 pt-2 border-t border-slate-50 animate-in slide-in-from-top-2 duration-300 space-y-3">
                                    <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-xs font-bold text-slate-400 pt-2">
                                        ...
                                        <div className="flex items-center gap-1.5">
                                            <User size={14} className="text-[#137fec]" />
