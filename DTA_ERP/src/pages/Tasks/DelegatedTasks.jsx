...
const DelegatedTasks = () => {
    ...
    return (
        <MainLayout title="Delegated Tasks">
            ...
            <div className="flex flex-wrap items-end gap-3 mb-8">
                ...
                <button
                    ...
                    className="h-11 w-11 flex items-center justify-center bg-[#137fec] text-white rounded-lg hover:bg-[#106bc7] transition-all shadow-sm"
                    title="Clear Filters"
                >
                ...
                {/* Export */}
                <button className="flex items-center gap-2 px-4 h-11 bg-[#137fec] hover:bg-[#106bc7] text-white rounded-lg font-bold text-sm transition-all shadow-sm">
                    <FileUp size={18} />
                    Export
                </button>
