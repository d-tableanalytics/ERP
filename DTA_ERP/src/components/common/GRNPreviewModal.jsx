...
const GRNPreviewModal = ({
  ...
  const downloadPDF = async () => {
    ...
    pdf.save(
      `${formData.transaction_type === "IN" ? "GRN" : "GDN"}_${formData.invoice_no}.pdf`,
    );
  };
    ...
    <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4">
      <div className="bg-white w-full max-w-5xl rounded-lg shadow-xl overflow-auto max-h-[95vh]">
        ...
        >
          ...
          {/* GRN TITLE */}
          <div className="border border-black text-center font-bold py-2 bg-gray-200 uppercase">
            ...
            <tbody>
              <tr>
                <td className="border border-black p-2 font-semibold w-1/6">
                  {formData.transaction_type === "IN" ? "GRN No:" : "GDN No:"}
                </td>
