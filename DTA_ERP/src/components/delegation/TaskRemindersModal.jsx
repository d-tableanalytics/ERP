        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-[2px]">
            <div className="w-full max-w-sm bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-800 overflow-hidden animate-in zoom-in-95 duration-200">
                                    ...
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`px-2 py-1 rounded-md text-[9px] font-black transition-all flex items-center gap-1.5 ${
                                                ...
                                                ? 'bg-slate-100 dark:bg-slate-800 text-[#137fec] shadow-sm' 
                            ...
                            <div className="flex items-center gap-2.5">
                                <div className="w-16">
                                    <input 
                                        ...
                                        className="w-full bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-lg p-2 font-black text-center text-[11px] focus:ring-4 focus:ring-[#137fec]/5 focus:border-[#137fec]/30 outline-none transition-all text-slate-800 dark:text-slate-100"
                                ...
                                <div className="flex-1">
                                    <select 
                                        ...
                                        className="w-full bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-lg p-2 font-black text-[10px] appearance-none cursor-pointer focus:ring-4 focus:ring-[#137fec]/5 focus:border-[#137fec]/30 outline-none text-center transition-all text-slate-800 dark:text-slate-100"
                                        style={{ colorScheme: 'dark' }}
                                    >
                ...
                <div className="p-4 border-t border-slate-100 dark:border-slate-800 flex items-center gap-2.5 bg-slate-50 dark:bg-slate-950/50">
                    <button 
                        onClick={addReminder}
                        className="flex-1 py-2 rounded-lg border-2 border-dashed border-slate-200 dark:border-slate-800 text-slate-400 font-black uppercase tracking-widest text-[9px] hover:border-[#137fec] hover:text-[#137fec] transition-all flex items-center justify-center gap-2"
                    >
                        <Plus size={14} />
                        ADD REMINDER
                    </button>
