                ...
                <div className="p-4.5 space-y-4">
                    ...
                    {(task.evidenceRequired || true) && (
                        <div className="space-y-3">
                            ...
                            <label className={`flex flex-col items-center justify-center w-full h-20 border-2 border-dashed rounded-xl cursor-pointer transition-all border-border-main hover:border-[#137fec] hover:bg-bg-main/30`}>
