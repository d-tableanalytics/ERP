            ...
            <div className="flex flex-col gap-3 overflow-y-auto max-h-[calc(100vh-25rem)] pr-1 custom-scrollbar">
                {tasks.map((task) => (
                    <div 
                        ...
                        className="bg-white dark:bg-slate-800 p-4 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-md transition-all group cursor-pointer border-l-4 border-l-transparent hover:border-l-[#00d194]">
