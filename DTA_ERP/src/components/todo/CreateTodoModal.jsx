        ...
        <div className="fixed inset-0 z-100 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
            <div className="bg-bg-card border border-border-main w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
                <div className="flex justify-between items-center p-5 border-b border-border-main bg-bg-main/50">
                    ...
                    <button onClick={onClose} className="p-2 hover:bg-bg-main rounded-full text-text-muted transition-colors">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    <div className="space-y-1.5">
                        <label className="text-[11px] font-bold text-text-muted uppercase px-1">Task Title</label>
                        <input
                            type="text"
                            name="title"
                            required
                    ...
                    <div className="space-y-1.5">
                        <label className="text-[11px] font-bold text-text-muted uppercase px-1">Description</label>
                        <textarea
                            name="description"
                            rows="3"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-1.5">
                            <label className="text-[11px] font-bold text-text-muted uppercase px-1">Due Date</label>
                            <input
                                type="datetime-local"
                                name="due_date"
                                required
                    ...
                    <div className="space-y-1.5">
                        <label className="text-[11px] font-bold text-text-muted uppercase px-1">Assign To</label>
                        <select
                            name="assigned_to"
